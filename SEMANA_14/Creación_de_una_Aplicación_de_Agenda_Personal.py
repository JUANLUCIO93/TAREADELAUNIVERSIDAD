# crear un contenedor como ejemplo una Aplicacion de Agenda Personal
...
boton_agregar = tk.Button(frame_acciones, text="Agregar Evento", command=agregar_evento, bg="yellow", fg="blue", borderwidth=1, relief="solid")
boton_agregar.pack(side=tk.LEFT, padx=10)

boton_eliminar = tk.Button(frame_acciones, text="Eliminar Evento Seleccionado", command=eliminar_evento, bg="yellow", fg="blue", borderwidth=1, relief="solid")
boton_eliminar.pack(side=tk.LEFT, padx=10)

boton_salir = tk.Button(frame_acciones, text="Salir", command=root.quit, bg="red", fg="black", borderwidth=1, relief="solid")
