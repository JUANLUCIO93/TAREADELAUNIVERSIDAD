...
class TaskManagerApp:
    def __init__(self, root):
        ...
        self.root.configure(bg="WHITE")  # BLANCO
        ...
        self.add_task_button = tk.Button(root, text="Añadir Tarea", command=self.add_task, bg="WHITE",
                                         fg="BLACK")  # Botón blanco y letra negra
        self.add_task_button.pack(pady=5)

        # Botón para marcar tarea como completada
        self.complete_task_button = tk.Button(root, text="Marcar como Completada", command=self.complete_task,
                                              bg="WHITE", fg="black")  # Botón blanco con letra negra
        self.complete_task_button.pack(pady=5)

        # Botón para eliminar tarea
        self.delete_task_button = tk.Button(root, text="Eliminar Tarea", command=self.delete_task, bg="gray",
                                            fg="black")  # Botón gris con letra negra
